...
var filter = m => m.author.id === message.author.id;
      ...
      message.channel.send(`:x: | **Çekilişin yapılacağı kanalın adını yaz**`).then(msg => {
            ...
            .setFooter("Destiny Bot çekiliş sistemi")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.MessageEmbed()
                        .setColor("RANDOM")
                        .setDescription("Ödülünü Moderatörleri Etiketleyerek Alabilirsin!").setFooter("Thé Emree bot çekiliş sistemi")
